...
?>
<p>Sửa danh mục,hãng sản phẩm</p>
<table border="1" width="50%" style="border-collapse: collapse;border: none;">
<form method="POST" action="tinhnangquantri/quanlydanhmucbaiviet/xuly.php?idbaiviet=<?php echo $_GET['idbaiviet'] ?>">
	<?php
	while ($dong = mysqli_fetch_array($query_sua_danhmucbv)) {
	?>
		<tr>
			<td>Tên danh mục <i class="fas fa-file-signature"></i></td>
